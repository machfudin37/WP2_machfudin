...
class Autentifikasi extends CI_Controller
{
  public function index()
  {
    ...
    $this->form_validation->set_rules('password','Password','required|trim|valid_email',['required' => 'Password Harus diisi']);
    if ($this->form_validation->run() == false) {
        $data['judul'] ='Login';
        $data['user'] = '';
        //kata 'login' merupakan nilai dari variabel judl dalam array $data dikirimkan ke view aute_header
